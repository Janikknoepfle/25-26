...
- Zuverlässige und qualitativ hochwertige Datenquellen ausfinding machen ([Hier ein Beispiel warum man BIP Daten von diktatorisch regierten Staaten nicht trauen kann](https://www.journals.uchicago.edu/doi/full/10.1086/720458))
...
- Gehen Sie auf die [Github Seite des Projektkurses](https://github.com/projektkurs-datascience/25-26)
- Klicken Sie auf des grünen "Code" Button
- Kopieren Sie sich die [angezeigte HTTPS](https://github.com/projektkurs-datascience/25-26.git)
...
Welche Information benötigen wir aus der Tabelle
  - .alert[Die Anzahl aller Arbeitslosen pro Gemeinde (d.h. SGB II und III gemeinsam) **aus dem Jahr 2023**]
  - Die Anzahl der Arbeitslosen pro Gemeinde für einen bestimmten Rechtskreis (z.B. nur SGB II)
  - Die Anzahl der Arbeitslosen pro Gemeinde für einen bestimmten Rechtskreis und ein bestimmtes Alter (z.B. SGB II alle unter 25 Jahre)
...
include_graphics("./figs/Alo_Ueberblick2023.png")
```
...
- **Alternative Datenquelle:** [Die Anzahl der Arbeitslosen für das Jahr 2023 unterteilt nach Ländern der Arbeitsagentur](https://statistik.arbeitsagentur.de/Statistikdaten/Detail/202312/iiia4/akt-dat-jz/akt-dat-jz-d-0-202312-xlsx.xlsx)
...
include_graphics("./figs/Alo_Laender2023.png")
```
...
# Einlesen des Tabellenblattes "SH" ohne die ersten 5 Zeilen und nur die Spalten 1-7
read_xlsx("../case-study/data/Schulden_2023.xlsx", sheet = "SH", skip = 5)[1:7] ->
...
.alert[Nutzen Sie für diese Aufgabe **Chat AI**.]
...
sheet_names <- excel_sheets("../case-study/data/Schulden_2023.xlsx")
...
schulden_individuell <- map_df(sheet_read, function(sheet) {
  tmp <- read_xlsx("../case-study/data/Schulden_2023.xlsx", sheet = sheet, skip = 5)[1:7]
...
https://play.kahoot.it/v2/lobby?quizId=4d61bc54-dfc6-4152-846f-b670642f6b5a
